...
export function Sidebar() {
  ...
  return (
    <motion.aside 
      ...
      className="w-64 bg-white dark:bg-[#16171f] border-r-[3px] border-gray-300 dark:border-white/20 hidden md:flex flex-col min-h-screen fixed left-0 top-0 z-50 shadow-md"
    >
      <div className="p-6 border-b-[3px] border-gray-300 dark:border-white/20 flex items-center justify-center">
        ...
        {links.map((link) => {
          ...
          return (
            <Link 
              key={link.href} 
              href={link.href}
              className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all text-xs font-bold border-[3px] ${
                isActive 
                  ? "bg-green-600 text-white border-green-600 shadow-md" 
                  : "bg-gray-50 dark:bg-white/5 text-gray-800 dark:text-gray-200 border-gray-300 dark:border-white/15 hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-950/40 hover:text-green-700 dark:hover:text-green-400"
              }`}
            >
      ...
      <div className="p-4 border-t-[3px] border-gray-300 dark:border-white/20 space-y-2">
        <Link href="/profile" className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold border-[3px] transition-all ${
          pathname === "/profile" 
            ? "bg-green-600 text-white border-green-600 shadow-md" 
            : "bg-gray-50 dark:bg-white/5 text-gray-800 dark:text-gray-200 border-gray-300 dark:border-white/15 hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-950/40 hover:text-green-700 dark:hover:text-green-400"
        }`}>
        ...
        <Link href="/settings" className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold border-[3px] transition-all ${
          pathname === "/settings" 
            ? "bg-green-600 text-white border-green-600 shadow-md" 
            : "bg-gray-50 dark:bg-white/5 text-gray-800 dark:text-gray-200 border-gray-300 dark:border-white/15 hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-950/40 hover:text-green-700 dark:hover:text-green-400"
        }`}>
