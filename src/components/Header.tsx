...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white dark:bg-[#16171f] border-b-[3px] border-gray-300 dark:border-white/20 px-6 py-4 flex items-center justify-between shadow-md">
