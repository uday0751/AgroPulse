...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 font-sans max-w-7xl mx-auto space-y-10">
      ...
      {/* Clean Top Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b-2 border-gray-200 dark:border-white/15 pb-4">
        <div>
        ...
        <div className="flex items-center gap-2 bg-white dark:bg-[#1a1b23] border-2 border-gray-200 dark:border-white/15 px-3.5 py-2 rounded-xl shadow-sm">
      ...
      <div 
        ref={heroRef}
        className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-900 via-emerald-800 to-green-950 p-6 md:p-10 text-white shadow-2xl border-2 border-green-600/60 dark:border-green-500/50"
      >
      ...
      <div 
        ref={tickerRef}
        className="bg-white dark:bg-[#1a1b23] border-2 border-gray-200 dark:border-white/15 p-4 rounded-2xl shadow-sm flex flex-col md:flex-row items-center justify-between gap-4"
      >
        ...
        <div className="flex items-center gap-4 overflow-x-auto w-full scrollbar-none text-xs font-bold">
          <div className="flex items-center gap-1.5 shrink-0 bg-gray-50 dark:bg-white/5 px-3 py-1.5 rounded-xl border-2 border-gray-200 dark:border-white/10">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <span className="text-xs font-black text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950 px-3 py-1 rounded-full border-2 border-green-300 dark:border-green-800">
          ...
          {modules.map((mod, i) => {
            ...
            return (
              <Link 
                key={i} 
                href={mod.href}
                className={`group bg-white dark:bg-[#1a1b23] p-6 rounded-3xl border-2 border-gray-200 dark:border-white/15 shadow-sm hover:shadow-xl hover:border-green-500 dark:hover:border-green-500 transition-all duration-300 flex flex-col justify-between ${mod.bgGradient}`}
              >
                <div className="space-y-4">
